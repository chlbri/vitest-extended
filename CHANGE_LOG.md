...
## **[1.5.1]** - _2025-09-06 17:15_

</summary>

- Upgrade dependencies
- Fix types for createTests
- 100% coverage
...
- Fixed a minor bug in the `createTests` function that caused intermittent
  errors.
...
- Creation of functions: `acceptation`, `createTests`, `done`, `each`,
  `types`
